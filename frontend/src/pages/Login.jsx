  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        const from = location.state?.from?.pathname || '/type'
    ...
    <div className="min-h-screen bg-black text-gray-300 font-mono flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Button
          ...
          className="w-full mb-6 bg-white text-black hover:bg-gray-100 font-semibold py-3 flex items-center justify-center gap-3"
        >
